...
- 상태: 완료 보관 — 128×128/PPU64/2-unit 제작·표시 방식 수용, 현재 쥐 외형 최종 미승인, v4 직접 자동화 공백 유지.
...
1. 현재 쥐 외형 재작업 방향은 별도 사용자 승인 작업으로 분리한다.
2. v4 `128×128 / PPU64 / world width 2` 직접 EditMode 자동화 공백을 위험으로 유지한다.
3. 승인 뒤 현재 쥐 외형 재작업 방향을 별도 사용자 승인 작업으로 분리한다.
