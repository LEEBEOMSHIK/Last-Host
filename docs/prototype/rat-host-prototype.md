...
| 포유류 적응 | 전이 | 이후 숙주 확장을 준비하는 선택지. 1차 프로토타입에서는 정식 숙주 전이가 아니라 보상이나 목표 접근성을 높이는 임시 효과로만 검증 |
...
상세 승인 질문은 `docs/prototype/rat-host-approval-packet.md`에 정리한다.

1. URP 사용 여부
2. Unity 버전
3. 프로토타입 변이 효과
4. 초기 조작 방식
5. 모든 프로토타입 비주얼에 플레이스홀더 에셋을 사용할지 여부
