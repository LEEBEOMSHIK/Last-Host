...
`docs/prototype/`는 쥐 숙주 1차 프로토타입 관련 문서를 성격별로 나눈다.

## 폴더 구조

- `official/`: 승인된 공식 범위와 기준 문서
- `approvals/`: 사용자 승인 패킷과 승인 이력
- `plans/`: 구현 계획과 실행 계획
...
- `plans/rat-host-ai-assisted-art-workflow.md`: AI 보조 래스터 초안의 승인·선별·캐릭터 3D 원본·8방향 렌더 준비·Unity 적용·QA 순서

## 확인 순서

사용자가 프로토타입 방향을 확인할 때는 다음 순서로 보면 된다.
