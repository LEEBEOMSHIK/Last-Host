...
- 현재 감지된 Unity 프로젝트 경로: `My project/`
...
1. `My project/`를 현재 Unity 프로젝트 루트로 사용할지 승인받는다.
...
7. `My project/Library/PackageCache/com.gamelovers.mcp-unity@*/Server~/build/index.js` 파일이 있는지 확인한다.
